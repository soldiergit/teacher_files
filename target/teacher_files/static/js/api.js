...
layui.define(['$tool','jquery'], function (exports) {
    ...
    var API = {
        ...
        GetFirstClassMenus:function(req,successCallback,errorCallback){
            doPost($tool.getContext() + 'sysmenu/firstClassMenus.do',req,successCallback,errorCallback);
        },
        AddMenu:function(req,successCallback,errorCallback){
            doPost($tool.getContext() + 'sysmenu/add.do',req,successCallback,errorCallback);
        },
        DeleteMenu:function(req,successCallback,errorCallback){
            doPost($tool.getContext() + 'sysmenu/delete.do',req,successCallback,errorCallback);
        },
        GetMenu:function(req,successCallback,errorCallback){
            doPost($tool.getContext()+'sysmenu/get.do',req,successCallback,errorCallback);
        },
        UpdateMenu:function(req,config,successCallback,errorCallback){
            doComplexPost($tool.getContext()+'sysmenu/update.do',req,config,successCallback,errorCallback);
        },
        ...
        delete:function(req,successCallback,errorCallback){
        ...
        update:function(req,successCallback,errorCallback){
