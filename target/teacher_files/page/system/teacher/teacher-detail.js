layui.use(['element', 'form', 'table', 'layer', 'laytpl', 'util'], function () {
    ...
    var paperInfoList = table.render({
        ...
        url: '/teacher_files_war/biz/paper_findByAuthor.action?teacherId=' + thisTeacherId,//数据接口
        page: true,//开启分页
    ...
    var matchInfoList = table.render({
        ...
        url: '/teacher_files_war/biz/match_findByTeacher.action?teacherId=' + thisTeacherId,//数据接口
        page : true,//开启分页
        height : "full-125",//容器高度
        limits : [10,15,20,25],
        limit : 20,
    ...
    var raceInfoList = table.render({
        ...
        url: '/teacher_files_war/biz/competition_findByTeacher.action?teacherId='+thisTeacherId,//数据接口
        page : true,//开启分页
        height : "full-125",//容器高度
        limits : [10,15,20,25],
        limit : 20,
    ...
    var teacherItemInfoList = table.render({
        ...
        url: '/teacher_files_war/biz/teacherItem_findByPerson.action?itemPersonId='+thisTeacherId,//数据接口
        page : true,//开启分页
        height : "full-125",//容器高度
        limits : [10,15,20,25],
        limit : 20,
